'''
    This script allows the user to create a threshold-offset curve by simulating
    the MRG compartment model. The nodal alignment to the DBS lead is swept from 
    -50% to +50%, and the thresholds plotted as a function of offset.
'''
...
shifts = np.arange(-0.5, 0.5+0.001, 0.1)
thresholds = []
...
ax.plot(shifts,(thresholds),'.-b', lw=1, ms=8)
ax.grid()
plt.show()
